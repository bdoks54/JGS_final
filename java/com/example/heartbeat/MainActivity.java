...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //key에 저장된 값이 있는지 확인. 아무값도 없다면 ""를 반환
        ...
        mBluetoothHandler = new Handler(){
            public void handleMessage(android.os.Message msg){
                if(msg.what == BT_MESSAGE_READ){
                    ...
                    if(readMessage != "E" && readMessage != "R") {
                        try {
                            i = Integer.parseInt(readMessage.trim());
                        } catch (Exception e) {
                        }
                        if (i < 150 && i > 40) {
    ...
    private void SendSMS(String phoneNum,int i) {
        ...
        if(i == 1) {
            ...
            try {
                ...
                smsManager.sendTextMessage(phoneNum, null, "응급상황이므로 " + address + "로 출동 부탁드립니다.", null, null);
            } catch (Exception e) {
